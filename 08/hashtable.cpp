...
// hashtable lookup routine
// the return value is the address of the parent pointer that owns the target
// node, which can be used to delete the target node
...
static size_t k_resizing_work = 128;
...
static void hm_start_resizing(HMap *hmap) {
  ...
  // create a bigger hashtable and swap
  hmap->ht2 = hmap->ht1;
